...
import { BiLockAlt, BiUser, BiUserPlus } from 'react-icons/bi';
        ...
        <div className="w-screen h-screen bg-primary-300 flex flex-col gap-8  pt-32 items-center px-2">
            <form onClick={(e) => e.preventDefault()} className="flex flex-col p-4 gap-6 rounded-xl justify-center items-center text-stone-50 w-full md:w-96">
                ...
                <div className="flex justify-center gap-4 w-full">
                    ...
                    <input type="text" className="w-full bg-primary-300 border-b-2 border-primary-200 placeholder-primary-100" placeholder="Username" />
                </div>
                ...
                <div className="flex justify-center gap-4 w-full">
                    <BiLockAlt className="h-5 w-5 text-orange-300"></BiLockAlt>
                    <input type="password" className="w-full bg-primary-300 border-b-2 border-primary-200 placeholder-primary-100" placeholder="Confirm password" />
                </div>
